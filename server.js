...
var Filmstrip = function (_Component) {
	...
	_createClass(Filmstrip, [{
		...
		value: function filmstripContainerJumpShifter(shiftTo) {
			...
			// console.log("filmstripWidth is: "+filmstripWidth+ " projectorDisplayWidth is: "+projectorDisplayWidth+" travelDistance is: "+travelDistance+" projectorBoxCenter is: "+projectorBoxCenter+" centerCell is: "+centerCell);
			// console.log("travelDistance >= 0 is: "+(travelDistance >= 0)+ " centerCell >= 0 is: "+(centerCell >= 0)+" travelDistance + centerCell >= 0 is: "+(travelDistance + centerCell >= 0));
			if (travelDistance >= 0) {
				// console.log("Out of bounds returning without shifting");
				return;
			}
			if (centerCell >= 0) {
				console.log("Under bounds returning shifting to zero");
				$('#filmstrip__container').css('left', 0);
			...
			if (centerCell <= travelDistance) {
				console.log("Out of bounds returning and shifting as far as possible");
			...
			// console.log("This would have shifted to: " + centerCell);
